...
<script lang="ts">
  ...
  async function handleGoogleSignIn() {
    ...
    try {
      ...
      // Redirect will happen in App.svelte based on auth state
    } catch (error: any) {
  ...
  <Card class="w-full max-w-md shadow-lg">
    ...
    <CardContent>
      ...
      <div class="relative my-4">
        <Separator />
        <span class="absolute left-1/2 -translate-x-1/2 -translate-y-1/2 px-2 bg-card text-muted-foreground text-xs">OR</span>
      </div>
